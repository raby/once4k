...
> **Status: early / work in progress.** The core executor and an in-memory store are in, with
> concurrency tests. Pluggable stores (JDBC, Redis), TTLs and a Spring integration are next. Not yet
> published.
